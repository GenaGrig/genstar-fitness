...
# Model for workout choices in the booking form
SERVICE_CHOICES = (
...
# Model for time choices in the booking form
TIME_CHOICES = (
    ("10:00", "10:00"),
    ("11:00", "11:00"),
    ("12:00", "12:00"),
...
class Appointment(models.Model):
    ...
    workout = (models.CharField(max_length=50,
                                choices=SERVICE_CHOICES, default="BODYATTACK"))
    ...
    def __str__(self):
        return f"client: {self.user.username} | day: {self.day} \
            | time: {self.time} | workout: {self.workout}"


class BookingSlots(models.Model):
    '''Model for the booking slots in the booking form'''
    WORKOUT_CHOICES = [
        ("BODYATTACK", "BODYATTACK"),
        ("BODYBALANCE", "BODYBALANCE"),
        ("BODYCOMBAT", "BODYCOMBAT"),
...
class Membership(models.Model):
    '''Model for the membership choices in the membership form'''
    MEMBERSHIP_CHOICES = [
        ("Standart", "Standart"),
        ("Student", "Student"),
